...
import com.lanyu96.querylogistics.service.BluetoothLeService;
...
public class BLEConnectActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init()
    {
        rev_sv = findViewById(R.id.act_BLE_rev_sv);
        rev_tv = findViewById(R.id.act_BLE_rev_tv);
        connect_state = findViewById(R.id.act_BLE_connect_state);
        send_btn = findViewById(R.id.act_BLE_send_btn);
        send_et = findViewById(R.id.act_BLE_send_et);
